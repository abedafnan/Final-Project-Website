...
<div class="super_container">
							...
							<ul class="top_nav_menu">
								...
								<li class="account">
									...
									<ul class="account_selection">
										<li><a href="login-register.php"><i class="fa fa-sign-in" aria-hidden="true"></i>Sign In</a></li>
	...
	<div class="main_slider" style="background-image:url(images/slider_1.jpg); margin-top: 0px;">
	...
	<div class="best_sellers">
		<div class="container">
			...
			<div class="row">
				<div class="col">
					<div class="product_slider_container" style="margin-top: 0">
