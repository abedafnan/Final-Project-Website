...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="images/othr-imgs/favicon.ico">
    

    <!-- All css files are included here. -->
    <!-- Bootstrap fremwork main css -->
    <link rel="stylesheet" href="styles/othr-css/css/bootstrap.min.css">
...
<body>
    ...
    <div class="wrapper fixed__footer">
        ...
        <div class="htc__login__register bg__white ptb--130" style="background: rgba(0, 0, 0, 0) url(images/othr-imgs/5.jpg) no-repeat scroll center center / cover ;">
            <div class="container">
                <div class="row">
    ...
    <script src="js/othr-js/vendor/jquery-1.12.0.min.js"></script>
    <!-- Bootstrap framework js -->
    <script src="js/othr-js/bootstrap.min.js"></script>
    <!-- All js plugins included in this file. -->
    <script src="js/othr-js/plugins.js"></script>
    <script src="js/othr-js/slick.min.js"></script>
    <script src="js/othr-js/owl.carousel.min.js"></script>
    <!-- Waypoints.min.js. -->
    <script src="js/othr-js/waypoints.min.js"></script>
